...
void main() {
  ...
  group('tezos service test', () {
    ...
    //   final id =
    //       await tezosService.
    //       sendOperationTransaction(walletStorage, [operation]);
    //
    //   expect(id?.isNotEmpty, true);
    // });
  });
...
class MockWalletStorage extends WalletStorage {
  ...
  Future<String> getTezosPublicKey({int index = 0}) async =>
      'edpkvB8a5H6uwbzKysXRzZ96EqT5pVouZFvz6Qye67sgcZFkSZS92x';

  @override
  Future<Uint8List> tezosSignMessage(Uint8List message,
          {int index = 0}) async =>
      Uint8List(64);
