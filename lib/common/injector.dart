...
Future<void> setup() async {
  ...
  injector.registerLazySingleton(() => Web3Client(
      ...
      injector()));
  injector.registerLazySingleton(() => TezartClient("https://hangzhounet.api.tez.ie"));
  ...
  injector.registerLazySingleton<CurrencyExchangeApi>(() => CurrencyExchangeApi(dio));
  ...
  injector.registerLazySingleton<TezosService>(() => TezosServiceImpl(injector(), injector()));
}
