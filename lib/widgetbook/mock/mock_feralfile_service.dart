...
class MockFeralfileService extends FeralFileService {
  ...
  Future<List<Exhibition>> getAllExhibitions({
    ...
    return [
      ...MockExhibitionData.listExhibition.sublist(
        offset,
        offset + limit < MockExhibitionData.listExhibition.length
            ? offset + limit
            : MockExhibitionData.listExhibition.length,
      ),
    ];
  }
  ...
  Future<FeralFileListResponse<AlumniAccount>> getListAlumni({
    ...
    final listAlumni = MockAlumniData.listAll.sublist(
      offset,
      offset + limit < MockAlumniData.listAll.length
          ? offset + limit
          : MockAlumniData.listAll.length,
    );
  ...
  Future<Exhibition> getSourceExhibition() async {
    return MockExhibitionData.sourceExhibition;
  }
  ...
  Future<FeralFileListResponse<FFSeries>> exploreArtworks({
    ...
    final series = MockFFSeriesData.listSeries.sublist(
      offset,
      offset + limit < MockFFSeriesData.listSeries.length
          ? offset + limit
          : MockFFSeriesData.listSeries.length,
    );
    return FeralFileListResponse(
      result: [
        ...series,
