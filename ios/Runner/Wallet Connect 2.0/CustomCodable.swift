...
extension CustomCodable: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let value = try? container.decode(String.self) {
            ...
            self.value = nil
        } else if let value = try? container.decode([String: CustomCodable].self) {
            self.value = value.mapValues { $0.value }
        } else if let value = try? container.decode([CustomCodable].self) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        case let value as Array<Any?>:
            try container.encode(value.map { CustomCodable($0) })
        case let value as Dictionary<String, Any?>:
            try container.encode(value.mapValues { CustomCodable($0) })
...
extension CustomCodable: Equatable {

    public static func == (lhs: CustomCodable, rhs: CustomCodable) -> Bool {
        ...
        case (let lhs as Double, let rhs as Double):
            return lhs == rhs
        case (let lhs as [String: CustomCodable], let rhs as [String: CustomCodable]):
            return lhs == rhs
        case (let lhs as [CustomCodable], let rhs as [CustomCodable]):
            return lhs == rhs
...
extension CustomCodable: CustomStringConvertible {
...
extension CustomCodable: CustomDebugStringConvertible {
